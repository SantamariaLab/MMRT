...
fitingdata=["r.Ca.Ca1" "r.Ca.Ca4" "r.Ca.Ca5" "r.Ca.Ca51" "r.Ca.Ca6" "r.K.K1" "r.K.K11" "r.K.K21" "r.K.K23" "r.K.K22" ...
    "r.Na.Na31" "r.Na.Na61" "r.Na.Na62" "r.Na.Na71" "r.Na.Na72" "r.Na.Na82"];
...
ratetable=table([1:16]',datapoints',ctype',Cps',cps95',dHs',dhs95',dSs',dss95',rsqs',Top')
ratetable.Properties.VariableNames={'OrigN','DP','Cond','Cps','cps95','dHs','dhs95','dSs','dSs95','rsqs','Top'}

bodyT=[37,38,37,37,39,37,37,37,37,37,21,21,21,37,37,7];
bodyT2=bodyT([1 3:5 8:13 14 16]); 
%filterthem
rsqcomp=[]
for i=1:16
    dummy=logfitsR(i);
...
tablefil2=tablefil1([1:11 13],:); %outlier from the same dataset from 14
